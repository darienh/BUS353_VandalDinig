...
/**
 Base class for all VandalDining views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the VandalDining view hierarchy (such as wrapped iOS UIViews) was touched.

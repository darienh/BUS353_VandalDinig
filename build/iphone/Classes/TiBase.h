...
// in simulator we redefine to format for VandalDining Developer console
...
{\
	NSString * exceptionName = [@"org.vandaldining." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vandaldining";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVandalDiningNativeItemNone = -1, 
	UIVandalDiningNativeItemSpinner = -2,
	UIVandalDiningNativeItemProgressBar = -3,
	
	UIVandalDiningNativeItemSlider = -4,
	UIVandalDiningNativeItemSwitch = -5,
	UIVandalDiningNativeItemMultiButton = -6,
	UIVandalDiningNativeItemSegmented = -7,
	
	UIVandalDiningNativeItemTextView = -8,
	UIVandalDiningNativeItemTextField = -9,
	UIVandalDiningNativeItemSearchBar = -10,
	
	UIVandalDiningNativeItemPicker = -11,
	UIVandalDiningNativeItemDatePicker = -12,
	
	UIVandalDiningNativeItemInfoLight = -13,
	UIVandalDiningNativeItemInfoDark = -14,
	
	UIVandalDiningNativeItemDisclosure = -15,
	
	UIVandalDiningNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VandalDining instances of

...
//Rare exceptions to indicate a bug in the _vandaldining code (Eg, function that a subclass should have implemented)
...
/**
 The base class for VandalDining proxies.
 */

...
@interface VandalDiningObject : KrollCoverageObject {
#else
@interface VandalDiningObject : KrollObject {
#endif
@private
...
extern NSString * VandalDining$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	VandalDiningObject *_vandaldining;
    KrollObject* console;
	BOOL shutdown;

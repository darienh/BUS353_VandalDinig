...
//@interface VandalDiningObject : NSObject
//@end

@interface VandalDiningObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VandalDiningObject class]])
		{
			for (NSString *key in [[(VandalDiningObject*)o modules] allKeys])
			{
